...
public class ContentDirectoryMonitorIT extends AbstractComponentTest {
  ...
  private List<BundleInfo> contentDirectoryMonitorDependencies() {
    return Arrays.asList(
        ...
        new BundleInfo("org.apache.commons", "commons-text"),
        ...
        new BundleInfo("org.slf4j", "slf4j-api"),
        new BundleInfo("com.diamondq.common", "common-thirdparty.cal10n.api"),
        new BundleInfo("javax.cache", "cache-api"),
        new BundleInfo("org.apache.servicemix.bundles", "org.apache.servicemix.bundles.ant"),
        new BundleInfo("org.apache.servicemix.bundles", "org.apache.servicemix.bundles.jaxp-ri"),
