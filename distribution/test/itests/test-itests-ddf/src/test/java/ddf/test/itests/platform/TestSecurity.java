...
public class TestSecurity extends AbstractIntegrationTest {
  ...
  //    // verify that transport policy is observed indirectly by verifying that a security header
  // with
  ...
  //    // verify that asymmetric policy is observed indirectly by verifying that a security header
  // with
  ...
  //    // verify that symmetric policy is observed indirectly by verifying that a security header
  // with
