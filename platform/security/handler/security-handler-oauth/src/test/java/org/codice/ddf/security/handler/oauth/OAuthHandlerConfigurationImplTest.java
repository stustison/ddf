...
import org.codice.ddf.security.handler.oidc.OidcHandlerConfigurationImpl;
...
public class OAuthHandlerConfigurationImplTest {
  ...
  private OAuthHandlerConfigurationImpl handlerConfiguration;
  ...
  public static void setupClass() {
    ...
    invalidProperties.put(
        OidcHandlerConfigurationImpl.RESPONSE_TYPE, "invalid defaultResponseType");
  ...
  public void constructWithNull() {
    handlerConfiguration = new OAuthHandlerConfigurationImpl(null);
  ...
  public void constructWithEmptyProperties() {
    handlerConfiguration = new OAuthHandlerConfigurationImpl(emptyProperties);
  ...
  public void constructWithInvalidProperties() {
    handlerConfiguration = new OAuthHandlerConfigurationImpl(invalidProperties);

    assertThat(handlerConfiguration.isInitialized(), is(true));
  }

  @Test
  public void constructWithValidProperties() {
    handlerConfiguration = new OAuthHandlerConfigurationImpl(validProperties);

    assertThat(handlerConfiguration.isInitialized(), is(true));

    assertThat(
        handlerConfiguration.getOAuthClient().getSecret(),
        is(validProperties.get(OidcHandlerConfigurationImpl.SECRET)));
    assertThat(
        handlerConfiguration.getOAuthConfiguration().getSecret(),
        is(validProperties.get(OidcHandlerConfigurationImpl.SECRET)));
  }
}
