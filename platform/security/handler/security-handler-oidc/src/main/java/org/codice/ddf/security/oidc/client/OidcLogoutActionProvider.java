    ...
    if (realmSubjectMap instanceof Map) {
      try {
        HttpServletRequest request =
            (HttpServletRequest) ((Map) realmSubjectMap).get("http_request");
        HttpServletResponse response =
            (HttpServletResponse) ((Map) realmSubjectMap).get("http_response");
        ...
        if (savedToken != null && savedToken.getSecurityToken("oidc") != null) {
          credentials = (OidcCredentials) savedToken.getSecurityToken("oidc");
        }
